...
public class WritePDF {
	...
	public void printPhieuNhap(PhieuNhap phieuNhap, List<ChiTietPhieuNhap> listCTPN) {
		...
		try {
			...
			Paragraph company = new Paragraph("Hiệu thuốc tây AE 6", fontBold15);
			...
			Paragraph paragraph4 = new Paragraph("Thời gian: " + formatDate.format(phieuNhap.getThoiGian()),
					fontNormal10);
			...
			for (ChiTietPhieuNhap ctpn : listCTPN) {
				...
				table.addCell(new PdfPCell(
						new Phrase(formatter.format(ctpn.getDonGia() * ctpn.getSoLuong()) + "đ", fontNormal10)));
			}
			...
			Paragraph paraTongThanhToan = new Paragraph(
					new Phrase("Tổng thành tiền: " + formatter.format(phieuNhap.getTongTien()) + "đ", fontBold15));
	...
	public void printHoaDon(HoaDon hoaDon, List<ChiTietHoaDon> listCTHD) {
		...
		try {
			...
			Paragraph company = new Paragraph("Hiệu thuốc tây AE J6", fontBold15);
			company.add(new Chunk(createWhiteSpace(20)));
			Date today = new Date(System.currentTimeMillis());
			company.add(new Chunk("Thời gian in phiếu: " + formatDate.format(today), fontNormal10));
			company.setAlignment(Element.ALIGN_LEFT);
			...
			for (ChiTietHoaDon cthd : listCTHD) {
				...
				table.addCell(new PdfPCell(
						new Phrase(formatter.format(cthd.getDonGia() * cthd.getSoLuong()) + "đ", fontNormal10)));
			}
			...
			Paragraph paraTongThanhToan = new Paragraph(
					new Phrase("Tổng thành tiền: " + formatter.format(hoaDon.getTongTien()) + "đ", fontBold15));
			paraTongThanhToan.setIndentationLeft(300);
